import os
from of_state_instacnes_new_activitybased.executesim import execute_sim
import of_state_instacnes_new_activitybased.config as cfg
import of_state_instacnes_new_activitybased.sim_flow_info_read as f_info
import of_state_instacnes_new_activitybased.sim_flow_meter_read as f_meter
from of_state_instacnes_new_activitybased.of_volumetric_attribute_writer import OFVolumetricAttributeWriter
...
if __name__ == '__main__':
    ...
    for e_f in files:
        print(e_f)
        execute_sim('/Users/Arunan/Documents/PCAP-Transfer/under_process/activity/%s.pcap' % e_f)
