...
def read_volumetric_attributes(config_dict):
    ...
    for e_device in device_info:
        ...
        for tid, dict_rate, dict_count in flow_meter:
            attribute_writer.put_reading(dict_rate,dict_count)
...
if __name__ == '__main__':
    ...
    for e_f in files:
        print(e_f)
        execute_sim('/Volumes/Seagate Backup Plus Drive/Ayyoob/pcap/training/24hour/%s.pcap' % e_f)
