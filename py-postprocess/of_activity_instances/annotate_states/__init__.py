...
class AnnotateStates:
    def __init__(self, annotation_files, annotation_margin_dict,ins_duration):
        self.annotation_files = annotation_files

        self.annotation_hash = {}
        self.annotation_margin_dict = annotation_margin_dict

        self.instance_duration = ins_duration
    ...
    def load_state_files(self):
        ...
        for e_f in self.annotation_files:
            ...
            for e_l in csv_reader:
                ...
                # if c_activity!='boot':
                #     print ('Annotation:%.0f\tStart:%.0f\tEnd:%.0f\t'%(c_time,activity_start,activity_end))
